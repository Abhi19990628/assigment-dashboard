...
SECRET_KEY = 'django-insecure-@j@)z8d_(mkw@drj0%mnm0fp=^9b=1cn$rha-qshh9c75)4+q6'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'dashboard_database',  # Corrected database name
        'USER': 'postgres',
        'PASSWORD': 'abhi123',
...
JSON_FILE_PATH = os.path.join(BASE_DIR, 'data', 'jsondata.json')
